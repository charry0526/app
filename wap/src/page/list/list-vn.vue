        ...
        <li class="list-body" v-for="item in list" :key="item.key">
          <div>
            <ul class="clearfix"
              ...
              <li class="li-base" >
                <span v-if="item.changed == 0" class="yellow">
                   {{ Number(item.close_root / 1000).toFixed(2) }}
                </span>
                <span v-else-if="item.changed < 0" class="red">
                 {{ Number(item.close_root / 1000).toFixed(2) }}
                </span>
              ...
              <li class="li-base">
<!--                <p><span>{{item.changed}} {{item.changedratio}}</span></p>-->
                <span v-if="item.changed == 0" class="yellow">-</span>
                <span v-else-if="item.changed < 0" class="red"> {{item.changed?item.changed/1000:'0'}}  {{item.changedratio}}%</span>
                <span v-else class="green"> {{item.changed?(item.changed/1000).toFixed(2):'0'}} {{item.changedratio}}%</span>
