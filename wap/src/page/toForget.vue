...
<!--          输入手机号码-->
          ...
          <div class="register-form-item input-model">
            ...
            <input class="register-input" style="width:1.4rem" placeholder="Nhập mã xác nhận" type="tel" pattern="[0-9]*"
                   v-model="code">
...
<!--                   pattern="[0-9]*" v-model="psd">-->
            <input class="register-input" placeholder="Nhập mật khẩu" type="password"
                   pattern="[0-9]*" v-model="psd">
